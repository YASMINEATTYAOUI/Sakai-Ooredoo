...
export class UsersComponent implements OnInit, OnDestroy {
    users: User[]; // Changed 'roles' to 'users'
    filteredData: User[]; // Changed 'roles' to 'users'
    name: any;

    userForm: FormGroup; // Changed 'roleForm' to 'userForm'
    ...
    user: User; // Changed 'role' to 'user'
    userDialog: boolean = false; // Changed 'roleDialog' to 'userDialog'
    userToUpdate: UserDto; // Changed 'roleToUpdate' to 'userToUpdate'

    deleteUserDialog: boolean = false; // Changed 'deleteRoleDialog' to 'deleteUserDialog'

    deleteUsersDialog: boolean = false; // Changed 'deleteRolesDialog' to 'deleteUsersDialog'

    selectedUsers: User[]; // Changed 'selectedRoles' to 'selectedUsers'

    submitted: boolean = false;

    userId: any; // Changed 'roleId' to 'userId'
    ...
    constructor(
        ...
        private userService: UserService, // Changed 'roleService' to 'userService'
